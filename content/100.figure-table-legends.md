...
<!-- Figure 2 -->
![**Overview of the `scpca-nf` workflow, report, and download file structures.**](https://raw.githubusercontent.com/AlexsLemonade/scpca-paper-figures/v0.1.1/figures/compiled_figures/pngs/figure_2.png?sanitize=true){#fig:fig2 tag="2" width="7in"}
