...
<!-- Figure 5 -->
![**Consensus cell type annotations.**](https://raw.githubusercontent.com/AlexsLemonade/scpca-paper-figures/main/figures/compiled_figures/pngs/figure_5.png?sanitize=true){#fig:fig5 tag="5" width="7in"}

A. Dot plot of marker gene expression across broad consensus cell type annotation groups.
The total number of cells across the ScPCA Portal in each cell type annotation group are shown in parentheses along the y-axis.
...
B. Barplot showing the percentage of each broad consensus cell type annotation across libraries for high-grade (left panel) and low-grade (right panel) glioma samples in the ScPCA Portal.
