...
Using Nextflow as the framework for `scpca-nf` with container images for each process makes the workflow modular, portable, and flexible for more modalities to be added as the Portal grows.
