...
Although these annotations have limitations because the references do not contain tumor cells, these methods provide a good starting point for further downstream analysis.
For example, we used correspondence between methods to derive ontology-aware consensus cell labels.
