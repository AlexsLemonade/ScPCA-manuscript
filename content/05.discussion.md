...
Joint information from consensus cell type annotations and CNV estimates may support researchers to identify and interrogate tumor cells, in particular for diagnoses where genomic alterations are common such as neuroblastoma (Figure {@fig:fig5D}) or osteosarcoma.
