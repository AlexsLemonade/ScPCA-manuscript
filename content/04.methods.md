...
After annotations for all samples in a given project have been validated, they are added to all `SingleCellExperiment` and `AnnData` objects (unfiltered, filtered, and processed) for that project on the Portal.
