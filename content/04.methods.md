...
Because the consensus cell types can encompass multiple cell types from this reference, we defined each consensus cell type's gene set as the union of all gene sets for the constituent reference cell types.
