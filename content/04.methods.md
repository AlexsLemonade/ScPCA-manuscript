...
The assigned cell type label and the minimum distance of the query cell to a reference cell in the model were added to the processed `SingleCellExperiment` object.
