...
We used the Benjamini-Hotchberg procedure to control the false discovery rate, and gene sets with significant overrepresentation were identified having a corrected $P-value <= 0.05$.
