...
We considered only those that are specific to a single cell-type with the exception of hematopoietic precursor cells, which express genes that are found in other more differentiated immune cells. 
