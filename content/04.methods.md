...
The raw and filtered counts matrix, slide images, and the summary report output by `spaceranger count` are included in the folder output from `scpca-nf`.
...
For this, we first identified cell types of interest as the set of all possible consensus cell types for each project. <!-- TODO: phrasing. -->
