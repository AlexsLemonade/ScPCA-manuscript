...
#### Cell types generated as part of the OpenScPCA Project
...
To date, cell types were assigned and validated for SCPCP000004 (Neuroblastoma) and SCPCP000015 (Ewing sarcoma).
For more information on exactly how the cell types for these projects were annotated, see their associated modules in the `OpenScPCA-analysis` GitHub repository [@url:https://github.com/AlexsLemonade/OpenScPCA-analysis], `cell-type-neuroblastoma-04` and `cell-type-ewings`, respectively. 
