...
Tumors are transcriptionally heterogeneous, highlighting the importance of using single-cell RNA-seq (scRNA-seq) in studying tumor samples [@doi:10.1101/gr.190595.115].
...
In spite of these resources, there have been considerably fewer efforts to harmonize and distribute data from pediatric tumors specifically.
...
As of January 2026, over 900 unique downloaders had accessed the Portal since its launch.
...
This pipeline increases transparency and facilitate research across multiple samples and projects without re-processing.
