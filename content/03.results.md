...
Across libraries within `SCPCP000004`, malignant cell type annotations from OpenScPCA (which does not use CNV information) (Figure {@fig:fig5}A) and the per-cell CNV (Figure {@fig:fig5}B) broadly correspond.
...
By contrast, only Mnocytes and neuronal cell types were overrepresented in `SCPCP000009` (brain and CNS tumors) bulk RNA-seq.
