...
Raw FASTQ files are not available for download from the Portal, but we direct users to where they access the raw FASTQ files via links to external repositories, such as the Database of Genotypes and Phenotypes (dbGaP) [@doi:10.1038/ng1007-1181; @doi:10.1093/nar/gkt1211], when available.
