...
Setup requires only installing Nextflow and a supported container engine like Docker or Apptainer, managing a single configuration file for the computing environment, and organizing input files.
