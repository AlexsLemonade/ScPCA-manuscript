...
<!--Q for reviewers: Do we want to expand more on the T cell figure in the supplements? Is this the right place for it?-->
...
However, there is notable heterogeneity even within HGG and LGG subtypes (Figure {@fig:fig4}C and Figure {@fig:fig4}D).
