...
Zooming in on the immune infiltrate in glioma samples reveals that the majority of immune cells in ScPCA samples are indeed classified as either myeloid cell types or T cell types, although there is notable heterogeneity even within HGG and LGG sub types (Figure {@fig:fig5}C). 
