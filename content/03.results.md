...
Downloads contain the unfiltered, filtered, and processed objects from `scpca-nf`, allowing users to perform their processing or to start their analysis from a processed object.
