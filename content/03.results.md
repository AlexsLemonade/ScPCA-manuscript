...
The cell type report output by `scpca-nf` contains a heatmap of the Jaccard index between cell type labels from each automated methods and the consensus cell type (an example is shown in Figure {@fig:fig3}C).
