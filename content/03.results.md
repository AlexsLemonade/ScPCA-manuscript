...
As an example of this, we show the distribution of cell types observed in all high-grade and low-grade glioma samples in Figure {@fig:fig5}B, which originate from six different projects and four different investigators. 
...
Zooming in on the immune infiltrate in glioma samples reveals that the majority of immune cells in ScPCA samples are indeed classified as either myeloid cell types or T cell types, although there is notable heterogeneity even within HGG and LGG subtypes (Figure {@fig:fig5}C). 
